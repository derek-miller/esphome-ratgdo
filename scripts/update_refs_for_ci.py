...
RATGDO_REPO = "derek-miller/esphome-ratgdo"
...
def main():
    ...
    for yaml_file in project_root.glob("*.yaml"):
        ...
        if "remote_package:" in content and "derek-miller/esphome-ratgdo" in content:
